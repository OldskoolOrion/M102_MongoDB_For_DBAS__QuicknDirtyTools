...
SET lpath=D:\_Development_\MongoDB307.x64\log.wt\
SET lnfixedpart=_mongod.wt.logfile
SET lfile=%lpath%%ldt%%lnfixedpart%

mongod.exe --port 38028 --storageEngine wiredTiger --dbpath D:\_Development_\MongoDB307.x64\data.wt -vv | tee %lfile%
